...
////////////// MODIFIED BY MO: override helpers///////////
// const helpers = Object.assign({}, uiautomator2Helpers, androidHelpers);
const helpers = Object.assign({}, androidHelpers, uiautomator2Helpers);
//////////////////////////////////////////////////////////
...
class AndroidUiautomator2Driver extends BaseDriver {
  ...
  async ensureAppStarts () {
    ...
    if (this.caps.androidCoverage) {
      ...
      ////////////// MODIFIED BY MO: add retryStartAppOnFailure options ///////////
      ...
      // });
      try {
          let retryStartAppOnFailure = this.caps.retryStartAppOnFailure == false ? false : true;
          await this.adb.startApp({
            pkg: this.opts.appPackage,
            activity: this.opts.appActivity,
            action: this.opts.intentAction,
            ...
            optionalIntentArguments: this.opts.optionalIntentArguments,
            stopApp: !this.opts.dontStopAppOnReset,
            retry: retryStartAppOnFailure,
          });	  	
      } catch (e) {
        logger.error(`EnsureAppStarts: ${e.message}`);
      }
      //////////////////////////////////////////////////////////////
    }
  ...
  async deleteSession () {
    ...
    if (this.uiautomator2) {
      try {
        ...
        ////////////// ADDED BY MO: remove chromedriver forward list///////////
