...
////////////// MODIFIED BY MO: add private capability retryStartAppOnFailure ///////////
...
commands.startActivity = async function (appPackage, appActivity,
  ...
  let args = {
    ...
    retry: this.opts.retryStartAppOnFailure, 
  };
...
commands.mobileWaitForIdle = async function (waitOpts) {
  return await this.uiautomator2.jwproxy.command('/appium/device/wait_for_idle', 'POST', waitOpts);
};
/////////////////////////////////////////////////////
